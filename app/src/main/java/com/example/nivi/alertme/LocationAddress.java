...
/**
 * Created by Poornima on 16-10-2015.
 */
            ...
            public void run() {
                ...
                try {
                    ...
                    if (addressList != null && addressList.size() > 0) {
                        ...
                        //editor.putString("Location", address.getAdminArea());
                        //editor.commit();
                        result = sb.toString();

                        Log.d(TAG,"Locality Address : "+address );
                        sp = PreferenceManager.getDefaultSharedPreferences(context);
                        editor = sp.edit();
                        editor.putString("location",address.getLocality());
                        editor.commit();
                    }
                } catch (IOException e) {
